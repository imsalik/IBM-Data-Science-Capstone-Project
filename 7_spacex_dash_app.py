...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                min=min_payload, max=max_payload+400, step=1000,
                                marks={0:'0',2500:'2500',5000:'5000',7500:'7500', 10000:'10000'},
                                value=[min_payload,max_payload+400]
                                )),
...
def get_scatter_chart(entered_site,payload_range):
    ...
    if entered_site == 'ALL':
        fig = px.scatter(spacex_df, x=spacex_df['Payload Mass (kg)'],
        y=spacex_df['class'],
        ...
        range_x=payload_range,
        title='Success Rate vs Payload Mass for Site '+entered_site)
        return fig
# Run the app
